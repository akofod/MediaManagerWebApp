...
<body>
    <div id="container">
        ...
        <div id="content">
            <form method="post" action="<c:url value='/admin/addpurchaseinfo.do'/>">
            		<h2>Add Purchase Location</h2>
        			<table>
            			<tr><td>Purchase Location: </td><td><input name="purLoc" type="text" class="txtfield" /></td></tr>
